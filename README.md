...
- Revisao da importacao B3 considera os eventos corporativos ja cadastrados via administracao/XLSX, sem exigir validacao administrativa de cobertura por ticker/periodo.
...
- Tela administrativa permite importar eventos corporativos por XLSX.
