...
export default function AdminPage() {
  ...
  const loadAdminData = useCallback(async (showLoading = true) => {
    ...
    try {
      ...
      const eventosResult = await listEventosCorporativos();
    ...
    <AppShell title="Administracao" subtitle="Gerencie eventos corporativos e acessos administrativos.">
      {error || notice ? (
        <div
          ...
          className={`fixed bottom-4 left-4 right-4 z-50 rounded-md border px-4 py-3 text-sm shadow-lg sm:left-auto sm:max-w-md ${
            error
      ...
      {!isLoading ? (
        <section className="grid gap-5 xl:grid-cols-[520px_1fr] 2xl:grid-cols-[620px_1fr]">
          <div className="flex flex-col gap-5">
            <article className="order-4 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <article className="order-5 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <article className="order-2 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <article className="order-6 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <article className="order-7 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
